...
class Department(db.Model):
    ...
    def __repr__(self):
        return "<Department code={} name={}>".format(self.dept_code, self.dept_name)
...
def phone_dir_nav():
    ...
    for emp in emps:
        if emp.dept is not None:
            print("\n{:8} {:11} {}\n".format(emp.name, emp.dept.dept_name, emp.dept.phone))
        else:
            print("\n{:8} {:11} {}\n".format(emp.name, "-", "-"))
...
def phone_dir_nav_eager():
    ...
    for emp in emps:
        if emp.dept is not None:
            print("{:8} {:11} {}".format(emp.name, emp.dept.dept_name, emp.dept.phone))
        else:
            print("{:8} {:11} {}".format(emp.name, "-", "-"))
...
def phone_dir_join():
    ...
    for name, dept, phone in emps:
        print("{:8} {:11} {}".format(name, dept, phone))
...
def phone_dir_join_class():
    ...
    for emp, dept in emps:
        print("{:8} {:11} {}".format(emp.name, dept.dept_name, dept.phone))
